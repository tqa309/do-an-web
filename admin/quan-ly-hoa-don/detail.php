...
if(isset($_POST["bill_id"])){
  $query ='SELECT `item_name`,`item_price`,`bill_detail_id`, `quantity`,`total_price` from `bill_detail`,`product`,`bill` WHERE bill_detail.bill_id=bill.bill_id AND bill_detail.bill_id=:bill_id AND bill_detail.item_id=product.item_id';
  $data = array(
