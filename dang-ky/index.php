...
<body class="bg-gradient-primary">
                        ...
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="InputUsername" placeholder="Tên tài khoản">
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user" id="InputEmail" placeholder="Địa chỉ Email">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="InputAddress" placeholder="Địa chỉ">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <a id="register" class="btn btn-primary btn-user btn-block" style="color:white;">
                                    Đăng ký
                                </a>
                               <!--  <hr>
    ...
    <script src="<?php echo $server ?>/vendor/jquery-easing/jquery.easing.min.js"></script>
    <script src="<?php echo $server ?>/vendor/vanillatoasts/vanillatoasts.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="<?php echo $server ?>/js/sb-admin-2.min.js"></script>
    <script src="<?php echo $server ?>/js/quanlisanpham.js"></script>
