<?php
    function Login() {
        ...
        if (!empty($_SESSION["userId"])) {
            ...
            echo <<<EOF
                <span class="px-3 border-right border-left"><i class="fa fa-user" aria-hidden="true"></i> $displayName  <a href="../dang-xuat" class="px-3 border-right border-left text-dark">Đăng xuất</a><span>
            EOF;
          }
          else {
