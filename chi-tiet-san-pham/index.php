    ...
    window.onload = function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                html += `<div class="col-6 col-lg-5 font-rale" style="font-size:18px;"> Giá gốc: </div>`;
                html += `<div class="col-6 col-lg-7 font-rale" style="font-size:18px;"> <strike>$ ${response.Price * 100} </strike> </div>`;
                html += `<div class="col-6 col-lg-5 font-rale" style="font-size:20px;margin-top:15px">Giá khuyến mãi: </div>`;
                html += `<div class="col-6 col-lg-7 font-rale"><span style="font-size:32px;"class="text-danger">$ ${response.Price}</span> <br><small class="text-dark font-size-12">&nbsp;&nbsp;Bao gồm VAT 10%</small></div>`;
                html += `</div>`;    
